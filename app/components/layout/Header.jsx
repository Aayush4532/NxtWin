              ...
              {isSignedIn ? (
                ...
                <div className="hidden md:flex items-center space-x-2">
                  <SignInButton mode="modal">
                    <button className="px-4 py-2.5 text-sm font-medium rounded-xl bg-transparent text-white/80 hover:text-white transition-colors">
                      Sign In
                    </button>
                  </SignInButton>
                  <SignUpButton mode="modal">
                    <button className="px-4 py-2.5 text-sm font-medium rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 text-white hover:from-emerald-400 hover:to-emerald-500 transition-all shadow-lg shadow-emerald-500/10">
                      Sign Up
                    </button>
                  </SignUpButton>
                </div>
